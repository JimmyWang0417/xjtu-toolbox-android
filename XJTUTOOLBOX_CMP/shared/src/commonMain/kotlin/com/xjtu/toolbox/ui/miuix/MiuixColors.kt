// Strict transcription of top.yukonga.miuix.kmp.theme.Colors
...
class MiuixColors(
    ...
    fun copy(
        ...
        disabledPrimary, disabledOnPrimary, disabledPrimaryButton, disabledOnPrimaryButton,
        disabledPrimarySlider,
        primaryContainer, onPrimaryContainer,
        secondary, onSecondary, secondaryVariant, onSecondaryVariant,
        ...
        background, onBackground, onBackgroundVariant,
        surface, onSurface, surfaceVariant,
        onSurfaceSecondary, onSurfaceVariantSummary, onSurfaceVariantActions, disabledOnSurface,
        ...
        outline, dividerLine, windowDimming,
        sliderKeyPoint, sliderKeyPointForeground, sliderBackground,
    )
}

@Stable
internal fun MiuixColors.updateColorsFrom(other: MiuixColors) {
    primary = other.primary; onPrimary = other.onPrimary
    primaryVariant = other.primaryVariant; onPrimaryVariant = other.onPrimaryVariant
    error = other.error; onError = other.onError
    errorContainer = other.errorContainer; onErrorContainer = other.onErrorContainer
    disabledPrimary = other.disabledPrimary; disabledOnPrimary = other.disabledOnPrimary
    disabledPrimaryButton = other.disabledPrimaryButton; disabledOnPrimaryButton = other.disabledOnPrimaryButton
    ...
    secondaryVariant = other.secondaryVariant; onSecondaryVariant = other.onSecondaryVariant
    disabledSecondary = other.disabledSecondary; disabledOnSecondary = other.disabledOnSecondary
    disabledSecondaryVariant = other.disabledSecondaryVariant; disabledOnSecondaryVariant = other.disabledOnSecondaryVariant
    secondaryContainer = other.secondaryContainer; onSecondaryContainer = other.onSecondaryContainer
    secondaryContainerVariant = other.secondaryContainerVariant; onSecondaryContainerVariant = other.onSecondaryContainerVariant
    ...
    background = other.background; onBackground = other.onBackground; onBackgroundVariant = other.onBackgroundVariant
    surface = other.surface; onSurface = other.onSurface; surfaceVariant = other.surfaceVariant
    onSurfaceSecondary = other.onSurfaceSecondary; onSurfaceVariantSummary = other.onSurfaceVariantSummary
    onSurfaceVariantActions = other.onSurfaceVariantActions; disabledOnSurface = other.disabledOnSurface
    surfaceContainer = other.surfaceContainer; onSurfaceContainer = other.onSurfaceContainer
    onSurfaceContainerVariant = other.onSurfaceContainerVariant
    surfaceContainerHigh = other.surfaceContainerHigh; onSurfaceContainerHigh = other.onSurfaceContainerHigh
    surfaceContainerHighest = other.surfaceContainerHighest; onSurfaceContainerHighest = other.onSurfaceContainerHighest
    outline = other.outline; dividerLine = other.dividerLine; windowDimming = other.windowDimming
    sliderKeyPoint = other.sliderKeyPoint; sliderKeyPointForeground = other.sliderKeyPointForeground
    sliderBackground = other.sliderBackground
}

fun miuixLightColorScheme(
...
internal val LocalMiuixColors = staticCompositionLocalOf { miuixLightColorScheme() }
